...
class ServoControlTypedef(sms_sts):
    def __init__(self, portHandler, EncoderData=None):
        ...
        # 编码器零位角度 0-360
        self.InitEncoderAngle = [275.25146484375, 54.31640625, 45.90087890625, 69.169921875, 165.91552734375, 156.02783203125, 138.2080078125, 298.80615234375]
        # 舵机目标位置 0-4095
        ...
        self.EncoderLastAngle = [275.25146484375, 54.31640625, 45.90087890625, 69.169921875, 165.91552734375, 156.02783203125, 138.2080078125, 298.80615234375]
